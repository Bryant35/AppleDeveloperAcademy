        ...
        NavigationView{
            VStack{
                ZStack{
                    ...
                    Text("Bagi kamu yang suka nonton drama Korea dan belum pernah menonton Descendants of the Sun, saya sarankan untuk nonton drama ini. Meskipun terlihat klise di awal, namun ceritanya menarik, akting dan lokasinya yang indah bisa membuat kamu terkesan dengan drama ini.").foregroundColor(.black).font(.system(size: 12)).multilineTextAlignment(.leading).padding().frame(width: 370).position(x:180, y:45)
                    HStack{
                    ...
                    ForEach(value, id: \.self){value in
                        VStack{
                            ...
                            ZStack{
                                ...
                                Text("Saya setuju drama Descendants of the Sun wajib untuk ditonton, 90% tidak akan menyesal karena plot nya yang tidak terduga.").font(.system(size: 10)).multilineTextAlignment(.leading).frame(width: 300).position(x:190, y:30).foregroundColor(.black)
                                HStack{
